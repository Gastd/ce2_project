...
\begin{document}
    \title{Concepting, Design and Manufacturing an H Bridge for Controlling Wheel Velocity in a Mobile Robot}
    ...
    \label{sec:acknowledgments}
        The authors would like to thank the members of laboratory LARA by given space, time and tips in addition to borrowing the milling machine.
